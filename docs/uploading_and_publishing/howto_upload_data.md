...
<div class="click-zoom">
    <label>
        <input type="checkbox">
        <img src="/assets/uploading_and_publishing/upload_menu.png" alt="Uploads page." width="90%" title="Click to zoom in">
    </label>
</div>
...
<div class="click-zoom">
    <label>
        <input type="checkbox">
        <img src="/assets/uploading_and_publishing/gwupload.gif" alt="Creating a new upload with DFT+GW data." width="90%" title="Click to zoom in">
    </label>
</div>
...
<div class="click-zoom">
    <label>
        <input type="checkbox">
        <img src="/assets/uploading_and_publishing/top_fields_uploads.png" alt="Top fields in uploads page." width="90%" title="Click to zoom in">
    </label>
</div>
...
<div class="click-zoom">
    <label>
        <input type="checkbox">
        <img src="/assets/uploading_and_publishing/upload_files.png" alt="Uploaded files." width="90%" title="Click to zoom in">
    </label>
</div>
...
<div class="click-zoom">
    <label>
        <input type="checkbox">
        <img src="/assets/uploading_and_publishing/entries.png" alt="Processed entries." width="90%" title="Click to zoom in">
    </label>
</div>
